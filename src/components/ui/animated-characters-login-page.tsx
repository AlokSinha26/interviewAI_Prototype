          ...
          <div className="relative w-full h-[500px]">
            ...
            <div
              ...
              style={{
                ...
                bottom: 0,
                width: '80px',
                height: (password.length > 0 && !showPassword) || (isTyping && password.length === 0 && !showPassword) ? '440px' : '400px',
            ...
            >
              <div
                className="absolute flex gap-2 transition-all duration-200"
                style={{
            ...
            >
              <div
                className="absolute flex gap-3 transition-all duration-200"
                style={{
              ...
              <div
                className="absolute w-8 h-1 bg-black rounded-full transition-all duration-200"
                style={{
